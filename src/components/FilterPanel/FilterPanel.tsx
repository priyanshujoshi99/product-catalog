...
export default function FilterPanel({
  ...
  return (
    <>
      ...
      <aside
        className={`${styles.filterCard} ${mobileOpen ? styles.filterCardMobileOpen : ''}`}
        data-testid="filter-panel"
      >
        <div className={styles.filterCardHeader}>
          <span className={styles.filterCardIcon} aria-hidden="true">
            🎯
          </span>
        ...
        <div className={styles.filterGroup}>
          <label className={styles.filterLabel} htmlFor="fc-category">
            Category
          </label>
          <select
            id="fc-category"
        ...
        <div className={styles.filterGroup}>
          <label className={styles.filterLabel} htmlFor="fc-rating">
            Minimum Rating
          </label>
          <select
            id="fc-rating"
        ...
        <div className={styles.filterGroup}>
          <label className={styles.filterLabel} htmlFor="fc-stock">
            Stock Status
          </label>
          <select
            id="fc-stock"
